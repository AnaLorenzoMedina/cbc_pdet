...
plt.figure(figsize=(8,4.8))
im = plt.scatter(data.dL/dmid_values, data.sigmoid(data.dL,dmid_values, emax_values, data.gamma, data.delta), s=1, c=emax_values, rasterized=True)
...
im = plt.scatter(data.chi_eff, mtot_det, s=1, c=chieff_corr, norm=LogNorm(vmin=0.4, vmax=2.6), cmap = 'Spectral', rasterized=True)
cbar = plt.colorbar(im)
